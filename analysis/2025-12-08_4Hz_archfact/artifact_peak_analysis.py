"""
Peak Artifact Analysis Script

16, 20, 24, 28, 32 Hz のピークがアーチファクトか脳波由来かを判定
...
from lib.sensors.eeg import prepare_mne_raw, calculate_psd, analyze_harmonics
...
# データパス
DATA_PATH = '/home/tsu-nera/repo/satoru/data/mindMonitor_2025-12-08--07-38-33_3000223989795832513.csv'
...
def generate_report(all_results, output_path):
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write("# Peak Artifact Analysis Report\n\n")
        f.write("## 分析対象\n")
        ...
        total_votes = artifact_votes + brain_votes
...
def main():
    ...
    plot_path = OUTPUT_DIR / 'artifact_peak_analysis.png'
    plot_comprehensive_analysis(psd_dict, raw, TARGET_PEAKS, plot_path)
    print(f"  Plot saved: {plot_path}")

    print("Generating report...")
    report_path = OUTPUT_DIR / 'artifact_peak_analysis_report.md'
